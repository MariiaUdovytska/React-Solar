			...
			<div className='carouselExternal'>
				<div className='carouselExternal__body'>
					<div className='carouselExternal__body-name'>
						<span className={((this.state.move==0)?' carouselExternal__active':'carouselExternal__noactive')} onClick={()=>{this.clickLabel(0)}}>продажа</span>
						<span className={((this.state.move==1)?' carouselExternal__active':'carouselExternal__noactive')} onClick={()=>{this.clickLabel(1)}}>закрепление</span>
						<span className={((this.state.move==2)?' carouselExternal__active':'carouselExternal__noactive')} onClick={()=>{this.clickLabel(2)}}>ограничения</span>
					</div>
