	...
	render(){
		return(
			<section className='services'>
				<div className='services__body containerM'>
					<div className='services__body-title titleM'>УСЛУГИ</div>
					<div className='services__body-row'>
						<div className='services__body-left'>
							<div className='services__body-left-info'>
								<div className='services__body-left-info-block'>
								...
								<div className='services__body-left-info-block'>
									...
									<p>Всю бюрократическую процедуру по подключению Вашей электростанции к «Зеленому тарифу», мы берем на себя, в том числе по увеличению договорной мощности вашего дома. При заказе солнечной электростанции эта услуга бесплатна.</p>
								</div>
							</div>
						</div>
						<div className='services__body-right'>
							<div className='services__body-right-img'></div>
						</div>
					</div>
